...
class Chat1ItemWidget extends StatelessWidget {
  Chat1ItemWidget(this.chat1ItemModelObj);

  Chat1ItemModel chat1ItemModelObj;

  var controller = Get.find<Chat3Controller>();
              ...
              children: [
                Align(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      ImageConstant.imgUnsplash4kzdi7,
                      height: getSize(
                        43.00,
                      ),
                      width: getSize(
                ...
                Align(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      ImageConstant.imgRectangle35814,
                      height: getSize(
                        43.00,
                      ),
                      width: getSize(
